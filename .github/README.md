...
[`@aws-sdk/client-iotdeviceadvisor`](https://www.npmjs.com/package/@aws-sdk/client-iotdeviceadvisor/v/3.25.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iotdeviceadvisor@3.25.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-C43EjY/N0aqgjNRtpJlsf0rwqBygoTy8KVxy3NIIkCVeEHTav2MSXTzLNkV+XuOn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-iotdeviceadvisor": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iotdeviceadvisor@3.25.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iotdeviceadvisor@3.25.0/index.min.mjs": "sha384-C43EjY/N0aqgjNRtpJlsf0rwqBygoTy8KVxy3NIIkCVeEHTav2MSXTzLNkV+XuOn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-iotdeviceadvisor/blob/refs/tags/3.25.0/LICENSE
```
