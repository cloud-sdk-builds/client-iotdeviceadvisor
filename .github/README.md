...
[`@aws-sdk/client-iotdeviceadvisor`](https://www.npmjs.com/package/@aws-sdk/client-iotdeviceadvisor/v/3.1016.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iotdeviceadvisor@3.1016.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XCy5Cu8kPXsse7K1gNHDFPW83mFnFI9MGEGeF/MPU+aiKoFjHdGenUIN0p+XL4Gw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-iotdeviceadvisor": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iotdeviceadvisor@3.1016.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iotdeviceadvisor@3.1016.0/index.min.mjs": "sha384-XCy5Cu8kPXsse7K1gNHDFPW83mFnFI9MGEGeF/MPU+aiKoFjHdGenUIN0p+XL4Gw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-iotdeviceadvisor/blob/refs/tags/3.1016.0/LICENSE
```
